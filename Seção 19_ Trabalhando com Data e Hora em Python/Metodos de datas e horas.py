"""
Metodos de Datas e Horas

# Com now() podemos especificar um timezoone | fusohorário
...
hoje_formatado = hoje.strftime("%d/%m/%Y") # y minusculo ele dá apenas o ano com 2 dígitos.
                                            # no lugar do mês B - Mês por escrito
                                            # no lugar do mês b - Mes por escrito abreviado.
...
nascimento = datetime.datetime.strptime("10/03/2010", "%d/%m/%Y")

print(nascimento)

nascimento = input("Qual sua data de nascimento? dd/mm/YYYY | Digite aqui: ")
