...
um atributi privado chamado__nome e um método privado
chamado __falar()

Esses elementos privados só devem/deveriam ser acessados
dentro da classe. Mas Python não bloqueia este acesso
fora da classe. Com Python acontece um fenômeno chamado Name Mangling, que faz uma alteração na forma de se acessar os
...
class Conta:
    ...
    def transferir(self, valor, conta_destino):
        ...
        self.__saldo -= valor
        self.__saldo -= 10 # Taxa de transferência para por quem realiza a transferência
        # 2 - Depositar na conta destino
