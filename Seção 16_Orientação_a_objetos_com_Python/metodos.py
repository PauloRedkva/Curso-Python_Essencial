...
-> Métodos (funções) -> Representam os comportamentos do objeto. Ou seja, as ações que este objeto pode realizar no meu sistema.
...
# Tod_o elemento em Python que inicia e finaliza com duplo underline é chamado de dunder (Double Underline)
# Os métodos/funções dunder em Python são chamados de métodos mágicos.

dir(__builtins__)

ATENÇÃO! Por mais que possamos criar nossas próprias funções dunder não é aconselhado. Python possui vários métodos de
nomenclatura e pode ser que mudemos o comportamento dessas funções mágicas internas da linguagem. Então, evite ao máximo
De preferência nunca o faça!

# Métodos são escritos em letras minúsculas. Se o nome for composto, o nome terá as palavras separadas por _ (underline)
...
user = Usuario("Paulo", "Eduardo", "pauloredkva@gmail.com", "1234567")
