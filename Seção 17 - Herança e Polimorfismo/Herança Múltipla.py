...
---///---
# Exemplo 1 - Multipladerivação Direta
...
print(tux.andar())
print(tux.nadar())
print(tux.cumprimentar())  # (ordem de Herança) Eu sou Tux da terra! | Eu sou Tux do mar! | Method Resolution Order (MRO)


# Objeto é instancia de ...
print(f"Tux é instancia de Pinguim? {isinstance(tux, Pinguin)}")
print(f"Tux é instancia de Aquático? {isinstance(tux, Aquatico)}")
